...
RMenu.Add('example', 'radio', RageUI.CreateSubMenu(RMenu:Get('example', 'main'), "Radio", "Menu Radio"))
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('example', 'main'), true, true, true, function()
            ...
            RageUI.Button("Radio", "Choisi ta Radio !", {RightLabel = "→→→"},true, function()

            end, RMenu:Get('example', 'radio'))
        ...
        RageUI.IsVisible(RMenu:Get('example', 'carte sim'), true, true, true, function()
            ...
            RageUI.Button("Carte Sim", "Achetez une Carte Sim !", {RightLabel = "~g~50$"}, true, function(Hovered, Active, Selected)
        ...
        RageUI.IsVisible(RMenu:Get('example', 'radio'), true, true, true, function()



            RageUI.Button("Radio", "Achetez une Radio !", {RightLabel = "~g~500$"}, true, function(Hovered, Active, Selected)

                if (Selected) then

                    TriggerServerEvent('powx_tuto:Buyradio')
            ...
            RageUI.IsVisible(RMenu:Get('example', 'téléphone'), true, true, true, function()
                ...
                RageUI.Button("Téléphone", "Achetez un Téléphone !", {RightLabel = "~g~350$"}, true, function(Hovered, Active, Selected)
